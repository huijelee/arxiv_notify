...
# Search parameters
search_query = 'ti:"sign language" AND cat:cs.*'
...
if new_papers:
    body = "New papers on arXiv with 'sign language' in the title in Computer Science:\n\n"
    ...
    send_email("arXiv Daily Update: Sign Language Papers", body)
